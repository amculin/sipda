                ...
                <div class="col">
                    <div class="page-pretitle mb-2">
                        <ol class="breadcrumb" aria-label="breadcrumbs">
                            ...
                            <li class="breadcrumb-item active"><a href="index.php">Analisis Kompetitor</a></li>
                        </ol>
                    </div>
                    <h2 class="page-title">Analisis Kompetitor</h2>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-outline-success btn-sm rounded-pill px-3"><i class="bi bi-star-fill me-2"></i> Lolos</a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                ...
                                <td>90</td>
                                <td>Rp. 1050.000.000</td>
                                <td>
                                    <a href="#" class="btn btn-outline-info btn-sm rounded-pill px-3"><i class="bi bi-download me-2"></i> Download</a>
                                </td>
                                <td>
                                    <a href="#" class="btn btn-outline-danger btn-sm rounded-pill px-3"><i class="bi bi-exclamation-circle-fill me-2"></i> Tidak Lolos</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Kompetitor</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-2">
                    <label for="" class="form-label">Nama Kompetitor</label>
                    <input type="text" class="form-control">
                </div>
                <div class="mb-2">
                    <label for="" class="form-label">Nilai/Skor Teknis</label>
                    <input type="text" class="form-control">
                </div>
                <div class="mb-2">
