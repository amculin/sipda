                ...
                <div class="col">
                    <div class="page-pretitle mb-2">
                        <ol class="breadcrumb" aria-label="breadcrumbs">
                            ...
                            <li class="breadcrumb-item active"><a href="index.php">Channel</a></li>
                        </ol>
                    </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-nowrap d-flex gap-2">
                                    ...
                                    <a href="?page=promosi-contact" class="text-dark"><i class="bi bi-people-fill" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Contact"></i></a>
                                ...
                                <td>List Contact seluruh Bappeda di Indonesia</td>
                            ...
                            <tr>
                                ...
                                <td>Ibrahim Jaya</td>
                                <td>Perusahaan Alat Kesehatan</td>
                                <td>List Contact seluruh perusahaan alat kesehatan di Indonesia</td>
                                <td class="text-center">40</td>
                            </tr>
