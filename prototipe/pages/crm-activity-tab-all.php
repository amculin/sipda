    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-nowrap gap-2 text-center">
                    <a href="#" class="btn btn-info btn-sm rounded-pill"><i class="bi bi-snow3 pe-2"></i>COLD</a>
                </td>
            </tr>
            <tr>
                <td>2</td>
                ...
                <td class="text-nowrap gap-2 text-center">
                    <a href="#" class="btn btn-warning btn-sm rounded-pill"><i class="bi bi-cloud-sun pe-2"></i>WARM</a>
                </td>
            </tr>
        </tbody>
    </table>
