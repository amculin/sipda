        ...
        <tbody>
            <tr>
                ...
                <td class="text-nowrap d-flex gap-2">
                    ...
                    <a href="#" class="text-danger" data-bs-toggle="modal" data-bs-target="#modal-konversi"><i class="bi bi-x-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Batal Failed"></i></a>
...
<div class="modal fade modal-blur" id="modal-konversi" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Batal Failed</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-2">
                    Apakah anda yakin mau membatalkan status Failed pada Leads ini?
                </div>
            </div>
            <div class="modal-footer">
            ...
            <div class="modal-body">
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            <div class="col-auto">
                                <span class="avatar bg-secondary rounded-circle"><i class="bi bi-slash-circle h1 m-0"></i></span>
                            </div>
                            <div class="col">
                                <div class="fw-bold mb-1 text-truncate">Fail</div>
                                <div class="text-secondary fs-5 hstack gap-3">
