                ...
                <div class="col">
                    <div class="page-pretitle mb-2">
                        <ol class="breadcrumb" aria-label="breadcrumbs">
                            ...
                            <li class="breadcrumb-item"><a href="index.php">Sales Order</a></li>
                            <li class="breadcrumb-item active"><a href="index.php">Form</a></li>
                        </ol>
                    </div>
                ...
                <div class="row justify-content-end">
                    ...
                    <div class="col-lg-4 text-end">
                        <table class="table table-borderless table-sm">
                            <tr>
                                <td>Nomor SO</td>
                                <td class="text-end">SO49/2310/0001045</td>
                            </tr>
                            <tr>
                                <td>Tanggal SO</td>
                ...
                <div class="row mt-2 g-3">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td>Catatan</td>
                            <td>
                                <textarea class="input-so" cols="80" rows="3"></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
