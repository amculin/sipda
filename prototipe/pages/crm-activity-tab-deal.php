        ...
        <tbody>
            <tr>
                ...
                <td class="text-nowrap d-flex gap-2">
                    ...
                    <a href="#" class="text-danger" data-bs-toggle="modal" data-bs-target="#modal-konversi"><i class="bi bi-x-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Batal Deal"></i></a>
...
<div class="modal fade modal-blur" id="modal-konversi" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Batal Deal</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-2">
                    Apakah anda yakin mau membatalkan status Deal pada Leads ini?
                </div>
            </div>
            <div class="modal-footer">
