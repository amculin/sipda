...
/** @var app\modules\sales\models\SalesOrderSearch $searchModel */
        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    <a href="<?= Url::to('/sales/orders/create', true); ?>" class="btn btn-primary d-none d-sm-inline-block">
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'template' => '{update} {approver} {print} {delete}',
                                'buttons' => [
                            ...
                            [
                                'header' => 'Nilai',
                                'value' => function ($data) {
                                    return is_null($data['sub_total']) ? 0 : number_format($data['sub_total'], 0, ",", ".");
                                },
...
$('#w1 a.quotation-approver').click(function(event) {
    ...
    Swal.fire({
        ...
        reverseButtons:true,
        confirmButtonText: 'Ya, ' + action + ' Sales Order!'
    }).then((result) => {
        if (result.isConfirmed) {
            $.ajax({
                ...
                success : function(data){
                    if (data.code == 200) {
                        var title = 'Sukses!';
                        var message = 'Sales Order Berhasil Di-' + action.toLowerCase();
                        var icon = 'success';
                    } else {
                        var title = 'Gagal!';
                        var message = 'Sales Order Gagal Di' + action.toLowerCase();
                        var icon = 'error';
                    }
                    Swal.fire(
                        title,
...
$this->registerJs($js, $this::POS_END, 'approver-handler');
?>
